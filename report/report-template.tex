...
Following histograms with error bars for standard deviation were derived by using the above results where y-axis implies the calculated average time and x-axis denotes the experiments in the form of (number of nodes, number of requests).

\setlength{\intextsep}{10pt plus 2pt minus 0pt}
\begin{figure}[!ht]
	\centering
	\includegraphics[width=7.5cm, height=5cm]{get.pdf}
	\caption{Histogram of GET requests for different parameters}
\end{figure}
...
\begin{figure}[!ht]
	...
	\caption{Histogram of PUT requests for different parameters}
\end{figure}
